...
#MCI        3i      DSTRI
#MCI  1.0000000 0.9715187 0.4743299
#3i   0.9715187 1.0000000 0.4690012
#DSTRI 0.4743299 0.4690012 1.0000000

#MCI        3i      DSTRI
#MCI  1.0000000 0.9529828 0.4667281
#3i   0.9529828 1.0000000 0.4690012
#DSTRI 0.4667281 0.4690012 1.0000000
...
# Display value for optimal k
# optimal = 2k (3 actually, but 3 is infinite) Dunn index = 18.45668 
...
#MCI        i3      DSTRI
#MCI  1.0000000 0.9715187 0.4743299
#i3   0.9715187 1.0000000 0.4690012
#DSTRI 0.4743299 0.4690012 1.0000000

#MCI        i3      DSTRI
#MCI  1.0000000 0.9715187 0.4899405
#i3   0.9715187 1.0000000 0.4690012
#DSTRI 0.4899405 0.4690012 1.0000000

#### "BROADNESS" OF INDICES ####

# MCI

# Filter the data frame for the year 2017
df1_filtered <- df1 %>%
  filter(year == 2017) %>%
