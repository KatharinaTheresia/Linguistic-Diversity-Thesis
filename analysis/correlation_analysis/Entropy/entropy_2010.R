...
# results differ significantly for EGDI vs H 
          ...
          #EGDI        IDI        EPI          H
#EGDI  1.0000000  0.9414284  0.8018228 -0.4095136
#IDI   0.9414284  1.0000000  0.6889861 -0.3980165
#EPI   0.8018228  0.6889861  1.0000000 -0.1771344
#H    -0.4095136 -0.3980165 -0.1771344  1.0000000

          #EGDI        IDI        EPI          H
#EGDI  1.0000000  0.9414284  0.7755306 -0.2978110
#IDI   0.9414284  1.0000000  0.6889861 -0.4046990
#EPI   0.7755306  0.6889861  1.0000000 -0.1430139
#H    -0.2978110 -0.4046990 -0.1430139  1.0000000

write.csv(cor_matrix, "entropy_cor_matrix_2010.csv", row.names = TRUE)
write.csv(cor_matrix_pair, "entropy_cor_matrix_pair_2010.csv", row.names = TRUE)
...
save_plot("2010_02_plot_pairs.jpg", pairs(
  ...
  cex.labels = 1,
  main = "Pairwise Correlations Plot with Entropy (2010)" 
))
