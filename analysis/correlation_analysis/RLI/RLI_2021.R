...
print(cor_matrix_pair)
            ...
            #MCI        NRI        DSTRI          IDI          3i          RLI
#MCI   1.00000000 0.95437096  0.41903954  0.945989560  0.96674523 -0.023634378
#NRI   0.95437096 1.00000000  0.45300826  0.883688948  0.91116364  0.013405432
#DSTRI  0.41903954 0.45300826  1.00000000  0.283708722  0.35069173 -0.098591583
#IDI   0.94598956 0.88368895  0.28370872  1.000000000  0.94546532 -0.004950072
#3i    0.96674523 0.91116364  0.35069173  0.945465318  1.00000000 -0.040953361
#RLI  -0.02363438 0.01340543 -0.09859158 -0.004950072 -0.04095336  1.000000000

          #MCI         NRI       DSTRI       IDI         3i          RLI
#MCI  1.0000000 0.945282154  0.3665410 0.9129407 0.95513029  0.139831982
#NRI  0.9452822 1.000000000  0.4521462 0.8410197 0.90280234  0.003987516
#DSTRI 0.3665410 0.452146155  1.0000000 0.2352916 0.27653177 -0.102391052
#IDI  0.9129407 0.841019664  0.2352916 1.0000000 0.90835668  0.121603736
#3i   0.9551303 0.902802340  0.2765318 0.9083567 1.00000000  0.034003409
#RLI  0.1398320 0.003987516 -0.1023911 0.1216037 0.03400341  1.000000000

# results differ signifcantly for RLI vs. MCI/IDI
...
pairs(
  ...
  cex.labels = 1,
  main = "Pairwise Correlations Plot with RLI (2021)" 
)
...
write.csv(summary_df, "2021_03_table_summary_comp.csv", row.names = TRUE)
...
write.csv(summary_df, "2021_04_table_summary_pair.csv", row.names = TRUE)
