...
# EGDI           1.00000000  0.94537834 0.6856945     0.01426342
# IDI            0.94537834  1.00000000 0.5854779    -0.07152344
# EPI            0.68569455  0.58547794 1.0000000     0.24134840
# language_count 0.01426342 -0.07152344 0.2413484     1.00000000

                    # EGDI         IDI       EPI language_count
# EGDI           1.0000000  0.94537834 0.6864797     0.17406046
# IDI            0.9453783  1.00000000 0.5854779    -0.08757181
# EPI            0.6864797  0.58547794 1.0000000     0.29940059
# language_count 0.1740605 -0.08757181 0.2994006     1.00000000

# Heatmap
plot <- ggcorrplot(cor_matrix_pair, hc.order = TRUE,  
                   type = "lower",  
                   colors = c("#6D9EC1", "yellow", "#E46726")) +
  ggtitle("Correlation Heatmap 2008") +
...
# Display the heatmap
save_plot("2008_01_plot_heatmap.jpg", print(plot))
...
save_plot("2008_02_plot_pairs.jpg", pairs(
  ~ EGDI + + IDI + EPI + language_count, 
  data = numeric_data, 
  lower.panel = panel.cor,
  cex.labels = 1,
  main = "Pairwise Correlations Plot with language count (2008)" 
))
...
write.csv(summary_df, "2008_03_table_summary_pair.csv", row.names = TRUE)
