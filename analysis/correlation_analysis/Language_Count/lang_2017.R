...
colnames(numeric_data) <- c("MCI", "DSTRI","3i", "language_count")
...
print(cor_matrix_pair)
                    ...
                    # MCI       DSTRI        3i language_count
# MCI            1.0000000 0.47432995 0.9715187     0.15745504
# DSTRI           0.4743299 1.00000000 0.4690012     0.07385119
# 3i             0.9715187 0.46900121 1.0000000     0.15448404
# language_count 0.1574550 0.07385119 0.1544840     1.00000000

                      # MCI        DSTRI        3i language_count
# MCI             1.00000000  0.46672814 0.9529828    -0.02762184
# DSTRI            0.46672814  1.00000000 0.4690012    -0.04882422
# 3i              0.95298280  0.46900121 1.0000000     0.09827770
# language_count -0.02762184 -0.04882422 0.0982777     1.00000000

# significant difference for MCI vs language count
...
save_plot("2017_02_plot_pairs.jpg", pairs(
  ...
  cex.labels = 1,
  main = "Pairwise Correlations Plot with language count (2017)" 
))
...
selected_columns <- c(idx_columns, "language_count")
numeric_data <- merged_data[, selected_columns]
colnames(numeric_data) <- c("MCI", "DSTRI","IDI", "language_count")
...
# no significant difference to full join 