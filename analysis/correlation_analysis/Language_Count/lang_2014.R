...
# MCI             1.00000000  0.53938347  0.952216888  0.9406770  0.9597287
# DSTRI           0.53938347  1.00000000  0.500789888  0.5285542  0.5557246
# EGDI            0.95221689  0.50078989  1.000000000  0.9471174  0.9630165
# DAI             0.94067704  0.52855416  0.947117358  1.0000000  0.9547299
# IDI             0.95972865  0.55572456  0.963016502  0.9547299  1.0000000
# EPI             0.71770516  0.39361758  0.828307146  0.7392510  0.6991556
# language_count -0.01522058 -0.08970541 -0.001230025 -0.1021803 -0.0800894
                    # EPI language_count
# MCI            0.7177052   -0.015220576
# DSTRI          0.3936176   -0.089705411
# EGDI           0.8283071   -0.001230025
# DAI            0.7392510   -0.102180311
# IDI            0.6991556   -0.080089403
# EPI            1.0000000    0.101912506
# language_count 0.1019125    1.000000000

                      # MCI       DSTRI        EGDI         DAI         IDI
# MCI             1.0000000  0.53938347  0.95481494  0.94537020  0.95310962
# DSTRI           0.5393835  1.00000000  0.50078989  0.52855416  0.55572456
# EGDI            0.9548149  0.50078989  1.00000000  0.94439216  0.95548350
# DAI             0.9453702  0.52855416  0.94439216  1.00000000  0.94655506
# IDI             0.9531096  0.55572456  0.95548350  0.94655506  1.00000000
# EPI             0.7729223  0.39361758  0.82831685  0.78430090  0.67485460
# language_count -0.0404673 -0.09077285 -0.04632888 -0.05412976 -0.08026865
                      # EPI language_count
# MCI            0.77292227    -0.04046730
# DSTRI          0.39361758    -0.09077285
# EGDI           0.82831685    -0.04632888
# DAI            0.78430090    -0.05412976
# IDI            0.67485460    -0.08026865
# EPI            1.00000000     0.06116198
# language_count 0.06116198     1.00000000

# sigfnicant difference for language count vs MCI
...
# Arrange plots
save_plot("2014_01_plot_heatmap.jpg", {
...
save_plot("2014_02_plot_pairs.jpg", pairs(
  ~ MCI + DSTRI + EGDI + DAI + IDI + EPI + language_count, 
  data = numeric_data, 
  lower.panel = panel.cor,
  labels = c("MCI", "DSTRI", "EGDI", "DAI", "IDI", "EPI", "language\ncount"),
  cex.labels = 1,
  main = "Pairwise Correlations Plot with Language Count (2014)" 
))
