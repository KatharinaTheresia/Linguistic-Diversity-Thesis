...
colnames(numeric_data) <- c("EGDI", "IDI", "EPI", "language_count")
...
# results differ significantly for  EGDI/EPI vs language count

                      # EGDI         IDI       EPI language_count
# EGDI            1.000000000  0.94142845 0.8018228   -0.001748095
# IDI             0.941428447  1.00000000 0.6889861   -0.079261676
# EPI             0.801822814  0.68898611 1.0000000    0.192845074
# language_count -0.001748095 -0.07926168 0.1928451    1.000000000

                    # EGDI         IDI       EPI language_count
# EGDI           1.0000000  0.94142845 0.7755306     0.15091412
# IDI            0.9414284  1.00000000 0.6889861    -0.09652457
# EPI            0.7755306  0.68898611 1.0000000     0.27352202
# language_count 0.1509141 -0.09652457 0.2735220     1.00000000

# significant difference for language count vs EGDI


write.csv(cor_matrix, "2010_1_cor_matrix.csv", row.names = TRUE)
write.csv(cor_matrix_pair, "2010_2_cor_matrix_pair.csv", row.names = TRUE)
...
# Arrange plots
save_plot("2010_01_plot_heatmap.jpg", {
...
save_plot("2010_02_plot_pairs.jpg", pairs(
  ~ EGDI + + IDI + EPI + language_count, 
  data = numeric_data, 
  lower.panel = panel.cor,
  cex.labels = 1,
  main = "Pairwise Correlations Plot with language count (2010)" 
))
...
write.csv(summary_df, "2010_03_table_summary_comp.csv", row.names = TRUE)
...
write.csv(summary_df, "2010_04_table_summary_pair.csv", row.names = TRUE)
