...
colnames(numeric_data) <- c("EGDI", "EPI", "language_count")
...
write.csv(cor_matrix, "2005_1_cor_matrix.csv", row.names = TRUE)
write.csv(cor_matrix_pair, "2005_2_cor_matrix_pair.csv", row.names = TRUE)

# results are almost identical 

                    # EGDI       EPI language_count
# EGDI           1.0000000 0.7730117      0.1805167
# EPI            0.7730117 1.0000000      0.3420032
# language_count 0.1805167 0.3420032      1.0000000

                    # EGDI       EPI language_count
# EGDI           1.0000000 0.7713026      0.1805167
# EPI            0.7713026 1.0000000      0.3420032
# language_count 0.1805167 0.3420032      1.0000000
...
plot <- ggcorrplot(cor_matrix_pair, hc.order = TRUE,  
  ...
  ggtitle("Correlation Heatmap 2005") +
...
# Display the heatmap
save_plot("2005_01_plot_heatmap.jpg", print(plot))
...
save_plot("2005_02_plot_pairs.jpg", pairs(
  ~ EGDI + EPI + language_count, 
  data = numeric_data, 
  lower.panel = panel.cor,
  cex.labels = 1,
  main = "Pairwise Correlations Plot with language count (2005)" 
))
...
write.csv(summary_df, "2005_03_table_summary.csv", row.names = TRUE)
