...
ggtitle("Correlation Heatmap of Indices (2008)") +
...
# Display value for optimal k
# optimal = 2k Dunn index = 5.754228  (actually 3, but 3 is infinite)
...
# Filter the data frame for the year 2008
df1_filtered <- df1 %>%
  filter(year == 2008) %>%
...
# there are only two idcs left
# web_measure_(idc)               1.00000
# broadband_index_(idc)           0.66657
...
# EPI does not have indicator values 