...
print(cor_matrix_pair)
                    ...
                    # MCI       DSTRI         IDI language_count
# MCI            1.0000000  0.53342914  0.95135042     0.02494090
# DSTRI          0.5334291  1.00000000  0.54589519    -0.05017739
# IDI            0.9513504  0.54589519  1.00000000    -0.02387239
# language_count 0.0249409 -0.05017739 -0.02387239     1.00000000

                      # MCI       DSTRI         IDI language_count
# MCI             1.00000000  0.53666845  0.94538469    -0.02181827
# DSTRI           0.53666845  1.00000000  0.54589519    -0.03929086
# IDI             0.94538469  0.54589519  1.00000000    -0.04913023
# language_count -0.02181827 -0.03929086 -0.04913023     1.00000000
...
# Display the heatmap
save_plot("2015_01_plot_heatmap.jpg", print(plot))
...
save_plot("2015_02_plot_pairs.jpg", pairs(
  ...
  cex.labels = 1,
  main = "Pairwise Correlations Plot with language count (2015)" 
))
...
write.csv(summary_df, "2015_03_table_summary_pair.csv", row.names = TRUE)
