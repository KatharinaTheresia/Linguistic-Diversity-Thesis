...
# no signifcant differents in the results 

                      # EGDI        IDI       EPI language_count
# EGDI            1.00000000  0.9622871 0.7256344    -0.05406361
# IDI             0.96228707  1.0000000 0.6586191    -0.11315343
# EPI             0.72563441  0.6586191 1.0000000     0.20394328
# language_count -0.05406361 -0.1131534 0.2039433     1.00000000

                      # EGDI        IDI       EPI language_count
# EGDI           1.000000000  0.9622871 0.7271421    0.001095398
# IDI            0.962287070  1.0000000 0.6587099   -0.126365419
# EPI            0.727142051  0.6587099 1.0000000    0.252974327
# language_count 0.001095398 -0.1263654 0.2529743    1.000000000

write.csv(cor_matrix, "2012_1_cor_matrix.csv", row.names = TRUE)
write.csv(cor_matrix_pair, "2012_2_cor_matrix_pair.csv", row.names = TRUE)
...
# Display the heatmap
save_plot("2012_01_plot_heatmap.jpg", print(plot))
...
save_plot("2012_02_plot_pairs.jpg", pairs(
  ~ EGDI + + IDI + EPI + language_count, 
  data = numeric_data, 
  lower.panel = panel.cor,
  cex.labels = 1,
  main = "Pairwise Correlations Plot with language count (2012)" 
))
#### Summary Statistics #####
...
write.csv(summary_df, "2012_03_table_summary.csv", row.names = TRUE)
