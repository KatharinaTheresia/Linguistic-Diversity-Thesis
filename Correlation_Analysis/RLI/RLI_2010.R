...
colnames(numeric_data) <- c("EGDI", "IDI", "EPI", "RLI")
...
print(cor_matrix_pair)
          ...
          #EGDI       IDI        EPI         RLI
#EGDI 1.00000000 0.9414284  0.8018228  0.04468466
#IDI  0.94142845 1.0000000  0.6889861  0.13144963
#EPI  0.80182281 0.6889861  1.0000000 -0.11895995
#RLI  0.04468466 0.1314496 -0.1189600  1.00000000

            #EGDI       IDI        EPI         RLI
#EGDI  1.00000000 0.9414284  0.7755306 -0.08033025
#IDI   0.94142845 1.0000000  0.6889861  0.10259162
#EPI   0.77553057 0.6889861  1.0000000 -0.12678556
#RLI  -0.08033025 0.1025916 -0.1267856  1.00000000
...
plot <- ggcorrplot(cor_matrix_pair, hc.order = TRUE,  
  ...
  ggtitle("Correlation Heatmap 2010") +
...
# Display the heatmap
save_plot("2010_01_plot_heatmap.jpg", print(plot))
...
save_plot("2010_02_plot_pairs.jpg", pairs(
  ...
  cex.labels = 1,
  main = "Pairwise Correlations Plot with RLI (2010)" 
))
...
write.csv(summary_df, "2010_03_table_summary_pair.csv", row.names = TRUE)
