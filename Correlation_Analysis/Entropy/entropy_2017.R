...
colnames(numeric_data) <- c("MCI", "DSTRI","3i", "entropy")
...
print(cor_matrix_pair)
            ...
            #MCI       DSTRI         3i          H
#MCI   1.0000000  0.4743299  0.9715187 -0.4389824
#DSTRI  0.4743299  1.0000000  0.4690012 -0.1222313
#3i    0.9715187  0.4690012  1.0000000 -0.4777769
#H    -0.4389824 -0.1222313 -0.4777769  1.0000000

            #MCI       DSTRI         3i          H
#MCI   1.0000000  0.4667281  0.9529828 -0.4352893
#DSTRI  0.4667281  1.0000000  0.4690012 -0.1660255
#3i    0.9529828  0.4690012  1.0000000 -0.4735388
#H    -0.4352893 -0.1660255 -0.4735388  1.0000000
...
plot <- ggcorrplot(cor_matrix_pair, hc.order = TRUE,  
  ...
  ggtitle("Correlation Heatmap 2017") +
...
# Display the heatmap
save_plot("2017_01_plot_heatmap.jpg", print(plot))
...
save_plot("2017_02_plot_pairs.jpg", pairs(
  ...
  cex.labels = 1,
  main = "Pairwise Correlations Plot with Entropy (2017)" 
))
...
#H    -0.4389824 -0.1222313 -0.4777769  1.0000000
            ...
            #MCI       DSTRI         3i          H
#MCI   1.0000000  0.4899405  0.9715187 -0.4264070
#DSTRI  0.4899405  1.0000000  0.4690012 -0.1513591
#3i    0.9715187  0.4690012  1.0000000 -0.4777769
#H    -0.4264070 -0.1513591 -0.4777769  1.0000000
